// Domain types used across the app. These mirror the Supabase schema
...
// Minimal Database type placeholder so supabase-js generics don't complain.
// For a fully typed client, generate this with:
