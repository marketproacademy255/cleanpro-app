 ...
 * there. The gateway calls back to our Netlify Functions
 * (see netlify/functions/payme.ts and netlify/functions/click.ts) to
 * confirm or cancel the transaction server-side.
 *
