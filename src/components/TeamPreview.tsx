  ...
  return (
    <section className="bg-gray-50 py-16">
      <div className="section">
        <h2 className="text-center text-3xl font-bold text-gray-900">Jamoamiz bilan tanishing</h2>
        <p className="mx-auto mt-2 max-w-xl text-center text-gray-500">
          Har bir xizmatchimiz shaxsan suhbatdan o'tgan va tajribasi tekshirilgan.
        </p>
        ...
        <div className="mt-8 text-center">
          <Link to="/xizmatlar" className="text-sm font-medium text-brand-700 hover:underline">
            Butun jamoani ko'rish →
          </Link>
        </div>
      </div>
    </section>
